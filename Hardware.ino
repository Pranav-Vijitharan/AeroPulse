...
void loop() {
  ...
  if (buttonState == LOW && (currentTime - lastDebounceTime) > DEBOUNCE_DELAY  && !isRecording) { 
...
void uploadFileToCloud() {
  ...
  http.begin("https://sutdwth2024-9zf8.onrender.com/upload"); // Replace with your server URL
